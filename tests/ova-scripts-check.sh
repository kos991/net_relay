...
grep -q "net-relay-alpine-x86_64.raw.img.gz" "${ROOT_DIR}/README.md"
grep -q "官方最新 release tag" "${ROOT_DIR}/README.md"
grep -q "镜像内置的是官方源码编译的" "${ROOT_DIR}/README.md"
grep -q "不内置 Docker/Compose" "${ROOT_DIR}/README.md"
grep -q "只保留一个版本" "${ROOT_DIR}/README.md"
